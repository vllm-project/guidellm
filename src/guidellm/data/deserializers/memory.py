...
class InMemoryDictDatasetDeserializer(DatasetDeserializer):
    def __call__(
        ...
        _ = (processor, random_seed)  # Ignore unused args format errors
        ...
        if (
            ...
            for deserializer in [
                ...
                with contextlib.suppress(DataNotSupportedError):
                    return deserializer()(parsed, data_kwargs, processor, random_seed)
        ...
        if (
            ...
            with contextlib.suppress(Exception):
                ...
                return InMemoryDictListDatasetDeserializer()(
                    rows, data_kwargs, processor, random_seed
                )

"""
Protocol definitions for constraint system interfaces.

Defines the core protocols that constraint implementations must adhere to,
including evaluation functions and initialization factories.
"""

...
embeddings benchmark performance including request statistics and input token metrics.
...
class EmbeddingsMetrics(StandardBaseDict):
    """
    Performance metrics for embeddings benchmarks.

    Encapsulates comprehensive performance data from embeddings workload executions
    including request-level statistics and input token metrics. Unlike generative
    metrics, embeddings metrics do not track output tokens or streaming behavior
    (TTFT, ITL).
    """

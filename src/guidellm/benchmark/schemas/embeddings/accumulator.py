...
Captures and computes performance metrics during embeddings benchmark runs,
tracking timing phases, request statistics, input token throughput, and latency
distributions. Unlike generative workloads, embeddings do not have output tokens
or streaming behavior, so this accumulator focuses on input processing metrics.
"""
...
class EmbeddingsBenchmarkAccumulator(
    ...
    input token processing and request latency. Does not track output tokens or
    streaming behavior.
    """

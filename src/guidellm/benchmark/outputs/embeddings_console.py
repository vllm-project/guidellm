...
latency measurements, and throughput data. Simplified compared to generative
output since embeddings don't have output tokens or streaming behavior.
"""
...
class EmbeddingsBenchmarkerConsole(EmbeddingsBenchmarkerOutput):
    ...
    throughput) with proper alignment and type-specific formatting for readability.
    """

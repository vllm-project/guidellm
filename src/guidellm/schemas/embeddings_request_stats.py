...
input token counts and latency measurements for evaluating embeddings
...
class EmbeddingsRequestStats(StandardBaseDict):
    ...
    including input token counts and timing measurements. Unlike generative requests,
    embeddings do not produce output tokens or have streaming behavior.

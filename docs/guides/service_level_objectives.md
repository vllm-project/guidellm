...
The search appends its outcome to `conclusions` in the benchmark report: every probe with its attainment and interval, the highest passing and lowest failing concurrency, and why the search stopped.
